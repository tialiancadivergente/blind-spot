...
const QUEST_WHATSAPP_URL_BY_TEMPERATURE = {
  f: "https://sendflow.click/i/superopc-2908-traf",
  org: "https://sendflow.click/i/superopc-2908-traf",
  m: "https://sendflow.click/i/superopc-2908-traf",
  q: "https://sendflow.click/i/superopc-2908-traf",
  t: "https://sendflow.click/i/superopc-2908-traf",
} as const;
