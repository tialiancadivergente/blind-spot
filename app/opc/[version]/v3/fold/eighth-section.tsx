			...
			<div className="relative min-h-[4414px] w-full max-w-[1200px] md:min-h-[3589px]">
				...
				<div className="hidden md:block">
					...
					<div className="absolute left-[610px] top-[1638px] w-[465px] text-white">
						...
						<Link
							href="https://pay.hotmart.com/T101582944K?checkoutMode=10"
							className="mt-[40px] flex h-[44px] w-[250px] items-center justify-center rounded-[50px] border-x border-[#25D366] px-[10px] font-raleway text-[16px] font-bold leading-[24px] text-white shadow-[0_-0.14px_1.92px_#25D36626,0_-0.35px_4.86px_#25D36636,0_-0.71px_9.92px_#25D36644,0_-1.46px_20.44px_#25D36654,0_-4px_56px_#25D3667A]"
							style={{ background: "radial-gradient(83.8% 393.52% at 45.2% 7.95%, #25D366 0%, rgba(37,211,102,0) 100%), linear-gradient(0deg,#015E53,#015E53)" }}
						>
							Garantir bônus extra
						</Link>
