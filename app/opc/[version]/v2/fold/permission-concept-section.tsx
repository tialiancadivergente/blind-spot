    ...
    >
      ...
      >
        ...
        <div className="font-raleway font-extrabold text-[18px] leading-[26px] md:text-[32px] md:leading-[40px]">
          ...
          <div className="md:hidden">
            <span className="block text-[#010D15]">Não é sobre TER mais dinheiro,</span>
            ...
            <span className="block text-[#010D15]">TER mais dinheiro.</span>
          </div>
        ...
        <div className="font-raleway font-medium text-[16px] leading-[24px] text-[#010D15]">
          ...
          <div className="md:hidden">
            ...
            <span className="font-bold">E EU VOU TE PROVAR AGORA</span> porque isso é real.
            <br />
            <br />
            Você já se perguntou por que sempre que você ganha ou está prestes a ganhar mais dinheiro,
            algo de ruim acontece?
            <br />
            <br />
            Do nada você perde tudo, uma batida de carro, uma compra mal planejada, um familiar no hospital…
          </div>
          ...
          <div className="hidden md:block">
            ...
            <br />
            é que não – <span className="font-bold">E EU VOU TE PROVAR AGORA</span>
            <br />
            porque isso é real.
            <br />
            <br />
      ...
      >
        <div className="w-full md:w-[520px] flex flex-col gap-[24px] md:gap-[32px]">
          ...
          <div className="font-raleway font-extrabold md:text-[32px] md:leading-[40px]">
            ...
            <div className="md:hidden text-[18px] leading-[26px]">
              ...
              <span className="text-white">estivesse acontecendo enquanto tudo acontece.</span>
            </div>
            ...
            <div className="hidden md:block text-[32px] leading-[40px]">
              ...
              <span className="text-[#D2A534]">alguma coisa</span>
              <br />
              <span className="text-[#D2A534]">estivesse acontecendo</span>
              <br />
              <span className="text-[#FFFFFF]">enquanto tudo acontece.</span>
            </div>
          </div>
          ...
          <div className="font-raleway text-white md:text-[16px] md:leading-[24px]">
            ...
            <div className="md:hidden font-medium text-[16px] leading-[24px] space-y-5">
              <p>
                Depois de anos de pesquisa, investigações e atendimentos, eu cheguei a resposta. Esse
                "azar" aparente se chama{" "}
                <span className="font-extrabold">Momento Pré-Queda:</span> um sintoma clássico de Falta de Permissão.
              </p>

              <p>Resultado?</p>

              <p>
                Depois de ter quebrado 17 vezes, chorado e quase desistido… apenas 3 anos após essa descoberta,
                eu fiquei milionário.
              </p>

              <p>
                Aconteceu comigo, com diversas pessoas e pode acontecer com você também{" "}
                <span className="font-extrabold">— se estiver presente n&apos;O Ponto Cego.</span>
              </p>
            </div>
        ...
        <button
          ...
          md:mt-[30px] md:w-[250px] md:h-[44px] md:mx-0
          "
          style={{
            background:
