export default function StudentsSection() {
    return (
        <section
            ...
            `}
        >
            <div className="max-w-[348px] md:max-w-[620px] mx-auto text-left md:text-center pt-[50px]">
                ...
                <div className="mt-4 text-[#010D15] font-raleway text-[14px] leading-[24px] md:text-[16px] md:leading-[24px] space-y-[20px] md:space-y-[8px]">
                    <p>
                ...
                <button
                    ...
                    md:mt-[467px] md:w-[250px] md:h-[44px]
                    "
                    style={{
                        background:
            ...
            <div className="absolute top-[1850px] left-1/2 -translate-x-1/2 w-[314px] text-left text-[#F4F0E1] font-raleway text-[14px] leading-[24px] space-y-[20px] md:hidden">
                ...
                <p>
                    ...
                    associado ao plano dos outros esconde uma responsabilidade oculta,
                    um débito emocional que você tem com outra pessoa, seja ela viva
                    ou morta.
                </p>
                ...
                <p>
                    Por isso que,{" "}
                    <span className="font-extrabold">
                        sempre que você ganha dinheiro, o seu inconsciente dá um jeito de se desfazer do dinheiro...
                    </span>
                </p>

                <p>
                    Seja dando esse dinheiro para outras pessoas resolverem os problemas delas,
                    seja fazendo novas dívidas ou pagando por "imprevistos" que sempre acontecem
                ...
                <p>
                    ...
                    <span className="font-extrabold">
                        você terá a oportunidade de sair
                    </span>{" "}
            ...
            <div className="absolute top-[2610px] left-1/2 -translate-x-1/2 w-[348px] md:hidden">
                <div className="space-y-[24px]">
                    <h2 className="font-raleway font-extrabold text-[18px] leading-[26px]">
                        ...
                        <br />
                        <span className="text-[#000C14]">se sentir incapaz, acabando com a sua</span>
                        <br />
            ...
            {/* TEXTO DESKTOP - INTACTO */}
            <div className="hidden md:block absolute top-[1050px] right-[180px] max-w-[454px] text-left text-[#F4F0E1] font-raleway text-[16px] leading-[24px] space-y-[16px]">
                <p>
                    Com que frequência você se pega dizendo -{" "}
                    <span className="font-extrabold">
                        "tenho que fazer isso pelo…"
                ...
                <p>
                    Se a resposta for ao menos UMA vez... você ainda não
                    pode ter dinheiro, mesmo podendo ganhar dinheiro.
                </p>
                ...
                <p>
                    ...
                    associado ao plano dos outros esconde uma responsabilidade oculta,
                    um débito emocional que você tem com outra pessoa, seja ela viva ou morta.
                </p>
                ...
                <div className="absolute top-[650px] left-[-390px] w-[520px] h-[347px] flex justify-center">
                    <div className="space-y-[16px]">
                        <h2 className="font-raleway font-extrabold text-[27px] leading-[35px]">
                            <span className="text-[#D2A534]">A falta de Permissão</span>
                            <span className="text-[#000C14]"> faz você</span>
                            <br />
                            <span className="text-[#000C14]">se sentir incapaz, acabando com</span>
                            <br />
                        ...
                        <div className="text-[#000C14] font-raleway text-[14px] leading-[24px] space-y-[8px]">
                            ...
                            <p>
                                ...
                                <br />
                                e as expectativas de um monte de pessoas que não deveriam
                                <br />
                            ...
                            <p>
                                ...
                                <br />
                                é que as pessoas não têm <span className="font-extrabold">PERMISSÃO</span> para prosperar e avançar
                                <br />
                                na vida.
                            </p>
                        </div>
            ...
            <div className="absolute top-[3320px] md:top-[2272px] left-1/2 -translate-x-1/2 w-[348px] md:w-[762px]">
                <h2 className="text-center font-raleway font-bold text-[18px] leading-[26px] md:text-[32px] md:leading-[40px] text-[#26333B]">
                    ...
                    <span className="md:hidden"> Permissão para ter sucesso, riqueza e</span>
                    <span className="hidden md:inline"> Permissão</span>
                    <br className="hidden md:block" />
                    <span className="md:hidden"> poder pessoal:</span>
                    <span className="hidden md:inline"> para ter sucesso, riqueza e poder pessoal:</span>
                </h2>
            </div>
                    ...
                    <div className="flex gap-[12px] w-max">
                        ...
                        >
                            ...
                            <p className="font-raleway font-medium text-[16px] leading-[24px] text-[#FFFFFF]">
                                Quando uma trava te prende onde você está e te impede de avançar o mínimo sequer na vida.
                                <br />
                                <br />
            ...
            <div className="hidden md:block absolute top-[2395px] left-1/2 -translate-x-1/2 w-full px-[20px] md:px-0">
